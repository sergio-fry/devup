    ...
    module V1
      RSpec.describe Compose do
        ...
        describe "#service_ports" do
          it { expect(compose.service_ports("nginx")).to eq [PortConfig.new("80"), PortConfig.new("81:8181")] }
          it { expect(compose.service_ports("postgres")).to eq [PortConfig.new("5432")] }
